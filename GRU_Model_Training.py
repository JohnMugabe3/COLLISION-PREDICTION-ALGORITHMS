...
gru_model = GRUPredictor(input_size, hidden_size, output_size, num_layers).to(device)
...
model_path = '/content/drive/MyDrive/UAV_DELIVERY_DATASET_FULL/gru_model.pth'
